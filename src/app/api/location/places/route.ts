...
const SUPPORTED_CATEGORIES = {
  ...
  park: ["leisure.park", "natural.water", "natural.forest"],
  museum: [
    "entertainment.museum",
    "entertainment.culture",
    "tourism.attraction",
  ],
  fitness: ["sport.fitness", "sport.swimming_pool", "sport.sports_centre"],
  shopping: [
  ...
  attraction: ["tourism.attraction", "tourism.sights", "entertainment.zoo"],
};
  ...
  try {
    ...
    if (categories) {
      ...
      const geoapifyCategories = categoryList.flatMap((category) => {
        return (
          SUPPORTED_CATEGORIES[category as keyof typeof SUPPORTED_CATEGORIES] ||
          []
        );
      });
